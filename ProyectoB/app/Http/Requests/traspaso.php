...
class traspaso extends FormRequest
{
    /**
    ...
    {
        return [
            "id" => "nullable|exists:traspaso,id",
            "local_origen"=> "required|unique:traspaso|integer",
            "local_destino" => "required|unique:traspaso|integer",
            "articulo" => "required|unique:traspaso|integer",
            "cantidad" => "required|unique:traspaso|string",
