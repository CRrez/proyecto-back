...
class local extends FormRequest
{
    /**
    ...
    {
        return [
            "id" => "nullable|exists:local,id",
            "nombre"=> "required|unique:local|string",
            "precio" => "required|unique:local|string",
            "id_fabrica" => "required|unique:local|integer",
